...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaseJWTApplication819.DataAccess.Entity.Developer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BaseJWTApplication819.DataAccess.Entity.Game", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BaseJWTApplication819.DataAccess.Entity.Genre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BaseJWTApplication819.DataAccess.Entity.UserAdditionalInfo", b =>
                {
                    ...
                    b.ToTable("tblUserAdditionalInfo");
                });
            ...
            modelBuilder.Entity("BaseJWTApplication819.DataAccess.Entity.Game", b =>
                {
                    b.HasOne("BaseJWTApplication819.DataAccess.Entity.Developer", "Developer")
                        .WithMany("Games")
                        .HasForeignKey("DeveloperId");

                    b.HasOne("BaseJWTApplication819.DataAccess.Entity.Genre", "Genre")
                        .WithMany("Games")
            ...
            modelBuilder.Entity("BaseJWTApplication819.DataAccess.Entity.UserAdditionalInfo", b =>
                {
                    b.HasOne("BaseJWTApplication819.DataAccess.Entity.User", "User")
                        ...
                        .HasForeignKey("BaseJWTApplication819.DataAccess.Entity.UserAdditionalInfo", "Id")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BaseJWTApplication819.DataAccess.Entity.User", null)
                        .WithMany()
